...
public class InventoryController {
    ...
    @GetMapping("/registry")
    public ResponseEntity<Page<InventoryResponse>> getInventoryRegistry(@PageableDefault(size = 15) Pageable pageable) {
        return ResponseEntity.ok(inventoryService.getAggregatedInventory(pageable, null));
